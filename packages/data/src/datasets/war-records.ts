...
import type { VictimChunk } from "@kosovatools/data-types"; export type { VictimChunk };
const DATASET_PREFIX = ["war"] as const;
const CHUNK_FILE_PREFIX = "deaths-part"; const fetchWarDataset = createDatasetFetcher(DATASET_PREFIX, {
